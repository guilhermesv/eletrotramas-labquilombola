...
void loop() {
  ...
  int amplitude = getSmoothedAmplitude();  // Calcula a amplitude do sinal
...
int getSmoothedAmplitude() {
  ...
  const float smoothing = 0.2;  // Ajuste este valor (0-1) para mais/menos suavização
